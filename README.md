...
- **[trial-based-cea-hta](./hta/trial-based-cea-hta/)** - Turn patient-level trial data into paired posterior draws of population-average cost and effect, covering QALY construction, baseline-utility adjustment, joint cost/effect models, structural values, and missing economic outcomes
